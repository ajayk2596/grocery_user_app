...
ProductApiModel productApiModelFromJson(String str) => ProductApiModel.fromJson(json.decode(str));

String productApiModelToJson(ProductApiModel data) => json.encode(data.toJson());
